...
public class MailServiceImpl extends AbstractService implements MailService {
	...
	/* (non-Javadoc)
	 * @see com.iv.rms.mail.MailService#sendMail(com.iv.rms.entity.Notification, com.iv.rms.entity.Owner)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.iv.rms.mail.MailService#sendAdminMail(java.lang.String, java.lang.String)
	 */
	@Override
